   	...
   	<form action="result.jsp" >
		 <table style="width : 300px; height:0px; margin: 0 auto" >
		 	...
		 	<figcaption>
		 		...
		 		<td>
		 	<figure>
		 			<img src="../../img/coffee.jpg" alt="" style="width : 200px; height:150px"  />    
		 	<figcaption>
				...
				<input type="number" name="coffee-count" style="width:30px" min="1" max="10" />개
		 		...
		 		<td>
		 		<figure>
		 				<img src="../../img/cokr.jpg" alt="" style="width : 200px; height:150px"  /> 
		 		<figcaption>
		 	...
		 	<tr>
		 		<td>
		 		<figure>
		 			<img src="../../img/chip.jpg" alt="" style="width : 200px; height:150px"  /> 
		 		<figcaption>
		 		...
		 		<td>
		 		<figure>
		 		<img src="../../img/salads.jpg" alt="" style="width : 200px; height:150px"  /> 	
		 	<figcaption>
				...
				<input type="number" name="salad-count" style="width:30px" min="1" max="10" />개		 		
		 		...
		 		<td>
		 	<figure>
		 		<img src="../../img/bagel.jpg" alt="" style="width : 200px; height:150px"  /> 
		 	<figcaption>
